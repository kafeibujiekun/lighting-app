...
class DeviceCommissionableDataProvider : public chip::DeviceLayer::CommissionableDataProvider
{
public:
    DeviceCommissionableDataProvider() {}
     ...
     */
    CHIP_ERROR Init(uint32_t spake2pIterationCount,
